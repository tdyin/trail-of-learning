...
var app = (function () {
    ...
    /* src/components/RatingSelect.svelte generated by Svelte v3.48.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$5, 15, 4, 275);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-ywbznt");
    			add_location(label0, file$5, 23, 4, 422);
    			attr_dev(li0, "class", "svelte-ywbznt");
    			add_location(li0, file$5, 14, 2, 266);
    			...
    			add_location(input1, file$5, 26, 4, 469);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-ywbznt");
    			add_location(label1, file$5, 34, 4, 616);
    			attr_dev(li1, "class", "svelte-ywbznt");
    			add_location(li1, file$5, 25, 2, 460);
    			...
    			add_location(input2, file$5, 37, 4, 663);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-ywbznt");
    			add_location(label2, file$5, 45, 4, 810);
    			attr_dev(li2, "class", "svelte-ywbznt");
    			add_location(li2, file$5, 36, 2, 654);
    			...
    			add_location(input3, file$5, 48, 4, 857);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-ywbznt");
    			add_location(label3, file$5, 56, 4, 1004);
    			attr_dev(li3, "class", "svelte-ywbznt");
    			add_location(li3, file$5, 47, 2, 848);
    			...
    			add_location(input4, file$5, 59, 4, 1051);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-ywbznt");
    			add_location(label4, file$5, 67, 4, 1198);
    			attr_dev(li4, "class", "svelte-ywbznt");
    			add_location(li4, file$5, 58, 2, 1042);
    			...
    			add_location(input5, file$5, 70, 4, 1245);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-ywbznt");
    			add_location(label5, file$5, 78, 4, 1392);
    			attr_dev(li5, "class", "svelte-ywbznt");
    			add_location(li5, file$5, 69, 2, 1236);
    			...
    			add_location(input6, file$5, 81, 4, 1439);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-ywbznt");
    			add_location(label6, file$5, 89, 4, 1586);
    			attr_dev(li6, "class", "svelte-ywbznt");
    			add_location(li6, file$5, 80, 2, 1430);
    			...
    			add_location(input7, file$5, 92, 4, 1633);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-ywbznt");
    			add_location(label7, file$5, 100, 4, 1780);
    			attr_dev(li7, "class", "svelte-ywbznt");
    			add_location(li7, file$5, 91, 2, 1624);
    			...
    			add_location(input8, file$5, 103, 4, 1827);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-ywbznt");
    			add_location(label8, file$5, 111, 4, 1974);
    			attr_dev(li8, "class", "svelte-ywbznt");
    			add_location(li8, file$5, 102, 2, 1818);
    			...
    			add_location(input9, file$5, 114, 4, 2021);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-ywbznt");
    			add_location(label9, file$5, 122, 4, 2171);
    			attr_dev(li9, "class", "svelte-ywbznt");
    			add_location(li9, file$5, 113, 2, 2012);
    			attr_dev(ul, "class", "rating svelte-ywbznt");
    			add_location(ul, file$5, 13, 0, 244);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/FeedbackForm.svelte generated by Svelte v3.48.0 */
    const file$4 = "src/components/FeedbackForm.svelte";

    // (54:6) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(54:6) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 56, 6, 1329);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 42, 4, 909);
    			attr_dev(header, "class", "svelte-f1fexd");
    			add_location(header, file$4, 41, 2, 896);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us what you think");
    			attr_dev(input, "class", "svelte-f1fexd");
    			add_location(input, file$4, 47, 6, 1091);
    			attr_dev(div, "class", "input-group svelte-f1fexd");
    			add_location(div, file$4, 46, 4, 1059);
    			add_location(form, file$4, 44, 2, 955);
    		},
    		m: function mount(target, anchor) {
    ...
    /* src/components/FeedbackItem.svelte generated by Svelte v3.48.0 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-dye5ry");
    			add_location(div, file$3, 13, 2, 288);
    			attr_dev(button, "class", "close svelte-dye5ry");
    			add_location(button, file$3, 16, 2, 343);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 17, 2, 417);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    /* src/components/FeedbackList.svelte generated by Svelte v3.48.0 */
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 7, 2, 204);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    /* src/components/FeedbackStats.svelte generated by Svelte v3.48.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$1, 10, 2, 234);
    			add_location(h41, file$1, 11, 2, 261);
    			attr_dev(div, "class", "feedback-stats svelte-ga2qn0");
    			add_location(div, file$1, 9, 0, 203);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	feedbackstas = new FeedbackStats({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			create_component(feedbackstas.$$.fragment);
    			t1 = space();
    			create_component(feedbacklist.$$.fragment);
    			attr_dev(main, "class", "container");
    			add_location(main, file, 11, 0, 318);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t0);
    			mount_component(feedbackstas, main, null);
    			append_dev(main, t1);
    		...
    		i: function intro(local) {
    			...
    			transition_in(feedbackstas.$$.fragment, local);
    			transition_in(feedbacklist.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(feedbackform.$$.fragment, local);
    			transition_out(feedbackstas.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(feedbackstas);
